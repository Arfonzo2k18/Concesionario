...
public class Extra {
    ...
    public Extra(){
        ...
        this.descripcion_extra = null;
    }

    public Extra(int cod_extra, String nombre_extra, double precio_extra, String descripcion_extra){
    ...
    public Extra(String nombre_extra, double precio_extra, String descripcion_extra){
        this.nombre_extra = nombre_extra;
        this.precio_extra = precio_extra;
        this.descripcion_extra = descripcion_extra;
    }
