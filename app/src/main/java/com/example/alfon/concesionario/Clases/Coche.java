...
public class Coche {
    ...
    public Coche(int cod_coche, String marca_coche, String modelo_coche, byte[] imagen_coche, double precio_coche, String descripcion_coche, int coche_usado){
        this.cod_coche = cod_coche;
    ...
    public Coche(String marca_coche, String modelo_coche, byte[] imagen_coche, double precio_coche, String descripcion_coche, int coche_usado){
        this.marca_coche = marca_coche;
        this.modelo_coche = modelo_coche;
        this.imagen_coche = imagen_coche;
        this.precio_coche = precio_coche;
