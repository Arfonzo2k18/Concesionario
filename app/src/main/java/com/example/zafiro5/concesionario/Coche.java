...
public class Coche {
    ...
    private String marca_coche, descripcion_coche;
    ...
    Coche(int cod_coche, String marca_coche, byte[] imagen_coche, double precio_coche, String descripcion_coche, int coche_usado){
        this.cod_coche = cod_coche;
